<template>
  <div
    class="error-page mx-auto h-full w-full flex flex-col items-center justify-center gap-20 container"
  >
    <svg
      class="animate-ping"
    ...
    <span class="text-5 font-bold text-white md:text-10 sm:text-8">
      {{ $route.query.message }}
    </span>
  </div>
</template>
