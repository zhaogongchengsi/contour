...
<template>
  <section
    class="mx-auto flex flex-col items-start gap-5 px-3 py-10 container lg:flex-row lg:px-0"
  >
    ...
    <div class="w-full flex-auto lg:flex-1">
      <div
        class="flex flex-wrap justify-center gap-3 lg:justify-start lg:gap-10 md:gap-8 sm:gap-5"
      >
