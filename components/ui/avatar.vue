...
<template>
  <div
    class="w-full h-full bg-white overflow-hidden rounded-full flex justify-center items-center"
    :class="{
      'p-1': avatar.type === 'url',
    }"
  >
    ...
    <span
      v-else-if="avatar.type === 'text'"
      :style="textSize(avatar.value)"
      class="w-full font-bold text-purple-500"
    >
      {{ avatar.value }}
    </span>
